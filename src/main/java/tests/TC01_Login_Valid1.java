...
public class TC01_Login_Valid1 extends BaseTest {
	...
	public void Invalid_Login_Test() throws Exception {
		...
		Login.App_Launch().Login_UserName_Text("").Login_Password_Text("").Login_Submit_Btn_Invalid()
				.Verify_Error_Msg("Incorrect Username/Password");
	...
	public void Valid_Login_Test() throws Exception {
		...
		Login.App_Launch().Login_UserName_Text(sUsername).Login_Password_Text(sPassword).Login_Submit_Btn_Valid()
				.Verify_Login();
